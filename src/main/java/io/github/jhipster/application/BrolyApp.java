...
public class BrolyApp {

    private static final Logger log = LoggerFactory.getLogger(BrolyApp.class);

    private final Environment env;

    public BrolyApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(BrolyApp.class);
